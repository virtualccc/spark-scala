package ch9.EstabilshModel.UserBasedCommand
...
object UserBasedModelEvaluate {
  ...
  sc.setLogLevel("WARN")
   ...
   def main(args: Array[String]) = {
     ...
     val modelPath ="E:\\spark大数据技术与应用\\46488_Spark大数据技术与应用_源代码和实验数据\\第9章\\任务程序\\USERBASE\\model"
     val minRatedNumPerUser = 1
     val args3="10,20,30,40,50"
     val kList = args3.split(",").map(_.toInt)
     val resultPath = "E:\\spark大数据技术与应用\\46488_Spark大数据技术与应用_源代码和实验数据\\第9章\\任务程序\\USERBASE\\res"
     val splitter = ","
